...
// Load the object and texture for each model here 
    ...
    ae86.object = new Object(objDir + "AE86Trueno.obj");
    ae86.object->load_to_buffer();
    ae86.object->load_texture(textureDir + "car\\Kuzov_remap.png");
    ae86.object->load_texture(textureDir + "car\\under.png");
...
// Update the heicopter position, camera position, rotation, etc.
    ...
    // ae86.position.y += moveDir;
    // if(ae86.position.y > 20.0 || ae86.position.y < -100.0){
    //     moveDir = -moveDir;
    // }
...
void render(){
    ...
    shaderPrograms[shaderProgramIndex]->set_uniform_value("model", ae86Model);
    ...
    // TODO 1
    // Set uniform value for each shader program, pass the variables into each shaders 
    /*
        1: Bling-Phong shading
        2: Gouraud shading
        3: Matellic shading
        4: Glass_schlick shading
        5: Glass_empricial shading    
    */
